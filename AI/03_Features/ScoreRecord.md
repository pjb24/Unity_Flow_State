...
InfiniteMode Stage Play의 최종 점수를 기록으로 확정한다.
...
- ScoreRecord는 InfiniteMode Stage Play의 최종 점수를 기록으로 확정한다.
...
- InfiniteMode Stage Play의 최종 점수가 기록으로 확정된다.
