...
- Stage Play 종료 후에는 동일한 Stage를 다시 선택하여 새로운 Stage Play를 시작할 수 있다.
...
- Stage 선택 후 Stage Play가 정상적으로 시작되는지 확인한다.
...
- Stage Play 종료 이후 동일한 Stage를 다시 선택하여 새로운 Stage Play를 시작할 수 있는지 확인한다.
